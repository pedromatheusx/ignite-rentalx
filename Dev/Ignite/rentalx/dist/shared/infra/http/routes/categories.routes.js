...
categoriesRoutes.post("/", _ensureAuthenticated.default, _ensureAdmin.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), _ensureAuthenticated.default, _ensureAdmin.ensureAdmin, importCategoryController.handle);